...
// images
import FormLoader from '../../../assets/images/form-loader.gif';
  ...
  return (
    <div id="contact" className="contact">
      <div className="contact-block">
        <div className="one form-text">
          <h1>CONTACT</h1>
          <p>
            Feel free to contact me for any inquiries or messages you want to
            tell. You can also download my resume with the button below. Looking
            forward talking with you!
          </p>
        </div>
        ...
        <ul>
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/arvey-jimenez-12b09ba4/"
            >
          ...
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.instagram.com/arveyj.07/"
            >
          ...
          <li>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://web.facebook.com/Arvey.Rombaoa.Jimenez"
            >
